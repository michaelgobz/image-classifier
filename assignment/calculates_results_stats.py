...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        results_stats_dic["n_correct_dogs"] += (
            1 if results_dic[key][3] == 1 and results_dic[key][4] == 1 else 0
        )
        ...
        results_stats_dic["n_correct_breed"] += (
            1 if results_dic[key][2] == 1 and results_dic[key][4] == 1 else 0
        )
    ...
    if results_stats_dic["n_notdogs_img"] > 0:
        ...
        print(
            "Number of Non-Dog Images is",
            results_stats_dic["n_notdogs_img"],
            "and therefore no percentage can be calculated",
        )
        results_stats_dic["pct_correct_notdogs"] = 0
